        ...
        <TabsContent value="qr" className="space-y-4">
          ...
          >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#C69234] via-[#DEB052] to-[#C69234] hover:from-[#D49E3B] hover:via-[#E8BC60] hover:to-[#D49E3B] text-[#3A2210] font-bold text-xs uppercase tracking-[0.15em] border border-[#ECC472]/60 transition-all cursor-pointer"
            >
